...
export default function RootLayout() {
  ...
  // Load fonts — capture error too so we can proceed even if a font fails
  ...
  // Hide splash screen once fonts are ready OR if loading errored
  useEffect(() => {
  ...
  // Initialize app runtime for iframe communication
  useEffect(() => {
    initAppRuntime();
  }, []);
